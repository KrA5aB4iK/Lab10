...
if __name__ == '__main__':
    ...
    sample_rate_a, samples_a = wavfile.read("lab_results/wavs/voice_a.wav")
    ...
    plt.legend()
    plt.savefig('lab_results/spectrogram_a.png', dpi=dpi)
    plt.clf()

    change_sample_rate("voice_i.wav")
    sample_rate_i, samples_i = wavfile.read("lab_results/wavs/voice_i.wav")
    ...
    plt.legend()
    plt.savefig('lab_results/spectrogram_i.png', dpi=dpi)
    plt.clf()

    change_sample_rate("voice_gav.wav")
    sample_rate_gav, samples_gav = wavfile.read("lab_results/wavs/voice_gav.wav")
    spectogram_gav, frequencies_gav = spectrogram_plot(samples_gav, sample_rate_gav, 11000)
    plt.savefig('lab_results/spectrogram_gav.png', dpi=dpi)
    plt.clf()
